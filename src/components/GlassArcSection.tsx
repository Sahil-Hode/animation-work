        ...
        <svg className="glass-donut__svg" viewBox="0 0 720 360">
          <defs>
            <linearGradient id="outerRim" x1="112" y1="112" x2="606" y2="112" gradientUnits="userSpaceOnUse">
              ...
              <stop offset="0.12" stopColor="#3d5cff" stopOpacity="0.55" />
              <stop offset="0.34" stopColor="#c9c4ff" stopOpacity="0.96" />
              <stop offset="0.49" stopColor="#ffffff" stopOpacity="1" />
              <stop offset="0.58" stopColor="#ffffff" stopOpacity="0.95" />
              <stop offset="0.7" stopColor="#c9c4ff" stopOpacity="0.86" />
              <stop offset="0.9" stopColor="#3d5cff" stopOpacity="0.5" />
            ...
            <linearGradient id="outerBlueGlow" x1="110" y1="142" x2="612" y2="142" gradientUnits="userSpaceOnUse">
              ...
              <stop offset="0.18" stopColor="#3d5cff" stopOpacity="0.42" />
              <stop offset="0.5" stopColor="#3d5cff" stopOpacity="0.78" />
              <stop offset="0.82" stopColor="#3d5cff" stopOpacity="0.34" />
              <stop offset="1" stopColor="#1a1aff" stopOpacity="0" />
            </linearGradient>

            <linearGradient id="rotatingSheen" x1="152" y1="88" x2="310" y2="88" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#ffffff" stopOpacity="0" />
              <stop offset="0.28" stopColor="#c9c4ff" stopOpacity="0.48" />
              <stop offset="0.52" stopColor="#ffffff" stopOpacity="1" />
              <stop offset="0.72" stopColor="#ff4fd8" stopOpacity="0.26" />
              <stop offset="1" stopColor="#3d5cff" stopOpacity="0" />
            </linearGradient>
            ...
            <radialGradient id="hotspotFill" cx="50%" cy="50%" r="50%">
              ...
              <stop offset="0.52" stopColor="#ffd8f6" stopOpacity="0.86" />
              <stop offset="0.76" stopColor="#c9c4ff" stopOpacity="0.36" />
              <stop offset="1" stopColor="#ff4fd8" stopOpacity="0" />
            </radialGradient>
            ...
            <filter id="wideBlueBloom" x="-42%" y="-155%" width="184%" height="410%">
            ...
            <filter id="liquidRipple" x="-8%" y="-28%" width="116%" height="168%">
              <feTurbulence baseFrequency="0.009 0.012" numOctaves="1" seed="4" type="fractalNoise" result="noise">
                <animate
                  className="glass-donut__wave-motion"
                  attributeName="baseFrequency"
                  dur="14s"
                  repeatCount="indefinite"
                  values="0.009 0.012;0.012 0.008;0.008 0.01;0.009 0.012"
                />
              </feTurbulence>
            ...
            <mask id="topArcReveal">
              <rect width="720" height="360" fill="black" />
              <path
                d="M 90 190 C 148 52 284 34 360 35 C 450 36 570 66 650 188"
                fill="none"
                stroke="white"
                strokeLinecap="round"
                strokeWidth="84"
              ...
              />
              <path
                d="M 150 205 C 214 116 304 96 360 96 C 432 96 510 122 574 202"
                fill="none"
                stroke="white"
                strokeLinecap="round"
                strokeWidth="40"
          ...
          <g mask="url(#bottomFade)">
            <g className="glass-donut__static-glow">
              <path
                d="M 92 187 C 150 58 286 36 360 37 C 452 38 568 70 642 185"
                fill="none"
                stroke="#3d5cff"
                strokeLinecap="round"
                strokeWidth="80"
                filter="url(#wideBlueBloom)"
                opacity="0.58"
              />
              <path
            ...
            <g className="glass-donut__liquid" filter="url(#liquidRipple)">
              <path
            ...
            <g className="glass-donut__counter-rotate">
              <path
            ...
            <g className="glass-donut__rotate" mask="url(#topArcReveal)">
              <path
                d="M 130 160 C 172 78 252 54 330 54"
                fill="none"
                stroke="url(#rotatingSheen)"
                strokeLinecap="round"
                strokeWidth="36"
                filter="url(#softBlueBlur)"
                opacity="0.56"
              />
              <path
                d="M 162 126 C 196 84 238 69 286 66"
                fill="none"
                stroke="url(#rotatingSheen)"
                strokeLinecap="round"
                strokeWidth="13"
